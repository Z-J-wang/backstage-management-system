...
<script>
import CreateNewExperience from "@/modules/person-management/components/edu_experience/CreateNewExperience.vue"; // item 编辑器
import EditExperience from "@/modules/person-management/components/edu_experience/EditExperience.vue"; // item 编辑器
import CheckExperience from "@/modules/person-management/components/edu_experience/CheckExperience.vue"; // item 查看器

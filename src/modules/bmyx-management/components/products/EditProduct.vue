	...
	>
		<div>
			...
			>
				...
				<el-form-item prop="s_Id" label="商品类别">
					<el-select
				...
				<el-form-item prop="nowPrice" label="平台价格">
					<el-input
				...
				<el-form-item prop="oldPrice" label="市面价格">
					<el-input
				...
				<el-form-item prop="videoSrc" label="视频链接">
					<el-row>
						<el-col :span="24">
							<upload-video
								width="120"
				...
				<el-form-item prop="detail" label="商品介绍">
					<el-input
...
export default {
	...
	methods: {
		 ...
		 */
		inputOldPrice() {
			this.formItem.oldPrice = this.formItem.oldPrice.match(/\d+(\.\d{0,2})?/)
